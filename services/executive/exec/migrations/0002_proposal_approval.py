# Executive 固有の Proposal / Approval（Issue #10）
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("proposal", models.ForeignKey(on_delete=models.CASCADE, related_name="approvals", to="exec.proposal")),
            ],
            options={
        ...
        migrations.AddConstraint(
            model_name="approval",
            constraint=models.UniqueConstraint(fields=("proposal", "by"), name="exec_unique_proposal_by"),
        ),
    ]
